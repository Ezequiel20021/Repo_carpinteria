...
<?php 
  ...
  if($_GET['pagina']>$paginas || $_GET['pagina']<=0){
    session_start();
    header("Location: misProductosFiltrados.php?pagina=1".($filtrado?'&filtro='.$filtrado:''));
  }
      ...
      <nav class="nav_paginacion" style="user-select: none">
            ...
            <ul class="paginacion">
              ...
              <li class="<?php echo $paginaActual <= 1 ? 'disable' : '' ?>">
                <a href="misProductosFiltrados.php?pagina=<?php echo $paginaActual -1 ?><?php echo ($filtrado?"&filtro=$filtrado":"") ?>">
            ...
            ?>
                <li class="" style="margin-right: 25px">
                  <a href="misProductosFiltrados.php?pagina=1">1</a>
                </li>
              <?php 
              }
              ...
              ?>
                  ...
                  ?>
                    <li class="<?php echo $paginaActual == $contadorDePaginaciones ? 'active' : '' ?>" style="<?php echo $clickDisabled;?>">
                      <a href="misProductosFiltrados.php?pagina=<?php echo $contadorDePaginaciones ?><?php echo ($filtrado?"&filtro=$filtrado":"") ?>">
              ...
              ?>
                <li class="<?php echo ($paginaActual == $paginas? 'active':'');?>" style="<?php echo (!$desaparecerUltimo && $paginas > $paginasAMostrar? 'margin-left: 25px':'');?>">
                  <a href="misProductosFiltrados.php?pagina=<?php echo $paginas?><?php echo ($filtrado?"&filtro=$filtrado":"") ?>">
                  <?php echo $i ?>
                  </a>
                </li>
